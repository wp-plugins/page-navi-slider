...
class WPNS_SETTING_PAGE{
  ...
  $this->_options = get_option( 'wpns_settings' );	
	...
	public function page_init(){        
		...
		add_settings_field('wpns_pn_width',__('Page numbers width','page-navi-slider'),array( $this, 'wpns_pn_width_callback' ),'wpns_settings_admin','wpns_general_section');      
	...
	public function sanitize( $input ){
		...
		if($input['wpns_caption_font_size']==''){$input['wpns_caption_font_size']='1em';}
		if($input['wpns_caption_font_lineheight']==''){$input['wpns_caption_font_lineheight']='1em';}
		if($input['wpns_caption_font_family']==''){$input['wpns_caption_font_family']='Arial,Helvetica,Sans-Serif';}
		$input['wpns_caption_font']=$input['wpns_caption_font_style'].' '.$input['wpns_caption_font_variant'].' '.$input['wpns_caption_font_weight'].' '.$input['wpns_caption_font_size'].'/'.$input['wpns_caption_font_lineheight'].' '.$input['wpns_caption_font_family'];
		
		if($input['wpns_page_font_size']==''){$input['wpns_page_font_size']='1em';}
		if($input['wpns_page_font_lineheight']==''){$input['wpns_page_font_lineheight']='1em';}
		if($input['wpns_page_font_family']==''){$input['wpns_page_font_family']='Arial,Helvetica,Sans-Serif';}
		$input['wpns_page_font']=$input['wpns_page_font_style'].' '.$input['wpns_page_font_variant'].' '.$input['wpns_page_font_weight'].' '.$input['wpns_page_font_size'].'/'.$input['wpns_page_font_lineheight'].' '.$input['wpns_page_font_family'];
		
		if($input['wpns_current_font_size']==''){$input['wpns_current_font_size']='1em';}
		if($input['wpns_current_font_lineheight']==''){$input['wpns_current_font_lineheight']='1em';}
		if($input['wpns_current_font_family']==''){$input['wpns_current_font_family']='Arial,Helvetica,Sans-Serif';}
		$input['wpns_current_font']=$input['wpns_current_font_style'].' '.$input['wpns_current_font_variant'].' '.$input['wpns_current_font_weight'].' '.$input['wpns_current_font_size'].'/'.$input['wpns_current_font_lineheight'].' '.$input['wpns_current_font_family'];
	
		if($input['wpns_hover_font_size']==''){$input['wpns_hover_font_size']='1em';}
	...
	public function print_font_fields($name,$value){
		//echo $name;
	}
