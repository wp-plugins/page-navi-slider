function page_navi_slider(index,param){
	...
	jQuery(".wpns_inactive").hover(
		function(){
			...
			jQuery(this).css('background-color',param['wpns_hover_back_color']);
		...
		function(){
			...
			jQuery(this).css('background-color',param['wpns_page_back_color']);
	...
	jQuery('.wpns_element').css('background-color',param['wpns_page_back_color']);
	jQuery('.wpns_active').css('color',param['wpns_current_fore_color']);
	jQuery('.wpns_active').css('background-color',param['wpns_current_back_color']);
	jQuery('.wpns_slider').css('background-color',param['wpns_slider_color']);
	jQuery('.wpns_slider').css('border',param['wpns_slider_border']);
	jQuery('.wpns_selector .ui-widget-content .ui-state-default').css('background-color',param['wpns_cursor_color']);
